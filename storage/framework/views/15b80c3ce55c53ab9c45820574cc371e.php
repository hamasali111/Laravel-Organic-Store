        ...
        <div>
            ...
            <div class="admin-card" style="margin-bottom:20px">
                ...
                <?php if($order->payment_proof): ?>
                    <div style="margin-bottom:16px">
                        ...
                        <img src="<?php echo e($order->payment_proof); ?>"
                            style="max-width:100%;max-height:300px;border-radius:8px;border:1px solid var(--border);object-fit:contain">
                    </div>
                <?php endif; ?>
            ...
            <div class="admin-card">
                ...
                <form method="POST" action="<?php echo e(route('admin.orders.update', $order->id)); ?>">
                    ...
                    <textarea name="admin_note" class="form-control" rows="3" placeholder="Send a message to the customer…"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\PMLS\Organic Hamas\resources\views/admin/orders/show.blade.php ENDPATH**/ ?>
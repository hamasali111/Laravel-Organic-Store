<?php $__env->startSection('title', 'Organic_store — Pure. Natural. Nourishing.'); ?>
    ...
    <section class="hero">
        <div class="hero-inner">
            ...
            <div class="hero-actions">
                <a href="<?php echo e(route('shop')); ?>" class="hero-btn hero-btn-primary">Shop Now</a>
            ...
            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('shop.category', $cat->slug)); ?>" class="cat-card">
                    ...
                    <div class="cat-card-overlay">
                        ...
                        <span><?php echo e($cat->products_count); ?> products</span>
                    </div>
                </a>
            ...
            <?php $__currentLoopData = $featured; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="product-card">
                    ...
                    <div class="product-card-body">
                        ...
                        <div class="product-card-desc"><?php echo e($product->description); ?></div>
...
<?php endif; ?>
        ...
        <div style="text-align:center;margin-top:40px">
            <a href="<?php echo e(route('shop')); ?>" class="btn btn-outline">View All Products</a>
        </div>
    </section>
    ...
    <section class="section" style="padding-top:0">
        <div style="max-width:700px;margin:0 auto;text-align:center;background:linear-gradient(135deg,#1b4332,#2d6a4f);border-radius:20px;padding:60px 40px;color:white;position:relative;overflow:hidden">
            ...
            <div style="position:relative">
                ...
                <?php else: ?>
                    <form action="<?php echo e(route('newsletter.subscribe')); ?>" method="POST" style="display:flex;gap:10px;justify-content:center;flex-wrap:wrap">
                        <?php echo csrf_field(); ?>
    ...
    <div style="max-width:1200px;margin:0 auto;padding:0 24px 80px">
        <div class="cta-section">
            ...
            <a href="<?php echo e(route('shop')); ?>" class="btn btn-primary btn-lg" style="font-size:1rem;padding:14px 36px">Start Shopping</a>
        </div>
    </div>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\PMLS\Downloads\Organic_Hamas_fixed\hamas organic store\resources\views/home.blade.php ENDPATH**/ ?>
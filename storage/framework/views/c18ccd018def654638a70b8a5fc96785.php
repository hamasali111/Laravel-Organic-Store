...
<div class="wrapper">
    ...
    ?>
    <div class="header" style="background:<?php echo e($statusColor['bg']); ?>">
        <h1 style="margin:0;color:<?php echo e($statusColor['txt']); ?>;font-size:1.5rem">Order Update</h1>
        <p style="margin:8px 0 0;color:rgba(255,255,255,.85);font-size:.9rem">
            Your order #<?php echo e(str_pad($order->id, 6, '0', STR_PAD_LEFT)); ?> status has changed
        </p>
    </div>
    <div class="body">
        <p style="margin:0 0 8px;font-size:.95rem">Hi <strong><?php echo e($order->shipping_name); ?></strong>,</p>
        <p style="margin:0 0 20px;font-size:.88rem;color:#5a7a5a">Here's the latest update on your order:</p>

        <div style="text-align:center">
            <span class="status-badge" style="background:<?php echo e($statusColor['bg']); ?>;color:<?php echo e($statusColor['txt']); ?>">
        ...
        <div class="steps">
            ...
            <?php $cls = $i < $currentIdx ? 'done' : ($i === $currentIdx ? 'current' : ''); ?>
            <div class="step">
                <div class="step-dot <?php echo e($cls); ?>"><?php echo e($i < $currentIdx ? '✓' : ($i + 1)); ?></div>
                <div class="step-lbl <?php echo e($cls); ?>"><?php echo e(ucfirst($s)); ?></div>
            </div>
        ...
        <div class="info-box">
            <strong>📦 Tracking Number:</strong> <?php echo e($order->tracking_number); ?><br>
...
<?php /**PATH C:\Users\PMLS\Downloads\Organic_Hamas_fixed\hamas organic store\resources\views/emails/order_status.blade.php ENDPATH**/ ?>
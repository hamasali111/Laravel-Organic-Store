...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Organic store'); ?> — Fresh &amp; Certified Organic</title>
...
<body>
    ...
    <?php if(auth()->guard()->check()): ?> <?php if(auth()->user()->is_admin): ?>
        <div class="admin-bar">
    ...
    <nav>
        <div class="nav-inner">
            ...
            <div class="nav-links">
                ...
                <?php $__currentLoopData = \App\Models\Category::take(8)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('shop.category', $cat->slug)); ?>"><?php echo e($cat->name); ?></a>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
            <div class="nav-actions">
                <?php $cartCount = \App\Models\CartItem::where('session_id', session()->getId())->sum('quantity'); ?>
                <?php if(auth()->guard()->check()): ?>
                    <div class="nav-dropdown">
                        <a class="user-profile-btn">
                            <img src="<?php echo e(asset('images/user.jfif')); ?>" alt="User" class="user-profile-img">
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="nav-btn nav-btn-outline">Log In</a>
                    <a href="<?php echo e(route('register')); ?>" class="nav-btn nav-btn-primary">Register</a>
                <?php endif; ?>
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('cart.index')); ?>" class="nav-btn nav-btn-primary">
                        🛒
                        <?php if($cartCount > 0): ?>
    ...
    <div class="flash">
        ...
        <?php endif; ?>
        <?php if($errors->any()): ?>
            <div class="flash-msg flash-error"><?php echo e($errors->first()); ?></div>
        <?php endif; ?>
    </div>
        ...
        <div class="footer-inner">
            <div class="footer-brand">
                <a href="<?php echo e(route('home')); ?>" class="footer-logo">
                    <img src="<?php echo e(asset('images/logo.avif')); ?>" alt="Organic Store Logo" class="footer-logo-img">
                </a>
    ...
    <div class="social-icons">
        ...
        <div class="footer-bottom">
            <span>© <?php echo e(date('Y')); ?> Organic_Store. All rights reserved.</span>
...
<?php /**PATH C:\Users\PMLS\Downloads\Organic_Hamas_fixed\hamas organic store\resources\views/layouts/app.blade.php ENDPATH**/ ?>
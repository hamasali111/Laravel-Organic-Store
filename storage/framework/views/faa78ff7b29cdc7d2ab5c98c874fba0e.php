<?php $__env->startSection('title', 'My Profile — Organic Store'); ?>
...
<div class="breadcrumb"><a href="<?php echo e(route('home')); ?>">Home</a><span>›</span>My Profile</div>
<div class="profile-wrap">
        ...
        <form method="POST" action="<?php echo e(route('profile.update')); ?>">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="tel" name="phone" class="form-control" value="<?php echo e(old('phone', auth()->user()->phone)); ?>" placeholder="Optional">
                </div>
            </div>
            <div class="form-group">
                <label class="form-label">Default Address</label>
                <textarea name="address" class="form-control" rows="2" placeholder="Your shipping address"><?php echo e(old('address', auth()->user()->address)); ?></textarea>
            </div>
    ...
    <div class="profile-card" style="border-color:#fca5a5">
        ...
        <form method="POST" action="<?php echo e(route('profile.destroy')); ?>" onsubmit="return confirm('Are you sure? This action cannot be undone.')">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\PMLS\Organic Hamas\resources\views/profile/edit.blade.php ENDPATH**/ ?>